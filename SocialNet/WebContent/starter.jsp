  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><%=u.getLog() %></a>
        </div>
      </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                     <%
				for (User user2 : us) {
					if(user2.getId()!=u.getId()){
					%> 
				                      <li>
                        <img src="dist/img/avatar.png" alt="User Image">
                        <a class="users-list-name" href="#"><%= user2.getLog() %></a>
                        <span class="users-list-date">Today</span>
                        <%
                        if(dao.isinvited(u.getId(), user2.getId(), false)==0)
                        {
                        %>
                                        <a href='Inviter?idus=<%= u.getId()%>&idur=<%= user2.getId() %>' class="card-link">inviter</a>
                        <%}
                        else
                        {
                        %>
                                        <a href="#" class="card-link">en cours</a>
